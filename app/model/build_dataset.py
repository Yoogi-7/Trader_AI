...
- Detect candidates on signal TF,
...
from app.data.store import path_raw, path_tf, RESAMPLED, DATA_DIR
...
def build() -> Path:
    ...
    for tf in ["10m", "30m"]:
        ...
        # detect candidates across entire df_tf
    ...
    if not rows:
        raise RuntimeError("No dataset rows were generated. Try more history or looser detector settings.")
